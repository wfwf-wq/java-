...
![img](https://img-blog.csdnimg.cn/20190329154059701.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzI4MDg5OTkz,size_16,color_FFFFFF,t_70)



- 一个 RPC 的核心功能主要有 5 个部分组成，分别是：客户端、客户端 Stub、网络传输模块、服务端 Stub、服务端等。

  [![img](https://s2.51cto.com/oss/201906/17/90dc3e7458138e6f2fd79297c50f347d.jpg-wh_600x-s_771365725.jpg)](https://s2.51cto.com/oss/201906/17/90dc3e7458138e6f2fd79297c50f347d.jpg-wh_600x-s_771365725.jpg)
...
1. rpc不需要像http每次都要三次握手，减少网络开销，因为是长连接。

2. RPC有注册中心，有监控管理。
3. rpc没有规定数据传输格式，不同rpc协议，数据格式不一定相同。
4. rpc对调用过程在api层面进行封装。http的请求响应细节都要自己实现。
5. http定义资源定位的路径，rpc不需要。
6. rpc自带负载均衡，http需要nginx等实习。
