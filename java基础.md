...
非公平锁：如果同时还有另一个线程进来尝试获取，那么有可能会让这个线程抢先获取；增加了速度

公平锁：如果同时还有另一个线程进来尝试获取，当它发现自己不是在队首的话，就会排到队尾，由队首的线程获取到锁。需要增加阻塞和唤醒的时间，
...
![1582282544693](C:\Users\56495\AppData\Roaming\Typora\typora-user-images\1582282544693.png)
